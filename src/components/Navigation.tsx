...
export function Navigation() {
  ...
  return (
    <nav className="fixed left-0 top-0 h-screen w-64 bg-white/20 backdrop-blur-2xl border-r border-white/30 hidden md:flex flex-col p-6 z-40">
      <div className="mb-10 px-2">
        <h1 className="text-2xl font-headline font-bold text-primary flex items-center gap-2">
          ...
          <span className="tracking-tight drop-shadow-sm">Resume Keeper</span>
        </h1>
      </div>
      ...
      <div className="mt-auto p-4 bg-primary/20 backdrop-blur-md rounded-2xl border border-white/30">
        <p className="text-[10px] font-bold uppercase tracking-widest text-primary mb-1">Theme</p>
        <p className="text-xs font-medium text-foreground/80">Tropical Lush</p>
      </div>
    </nav>
  );
}
